<template>
  <div v-if="subcategory" class="flex items-center gap-1.5 text-body px-1 py-0.5 animate-fade-in-up">
    <button class="text-grey-500 hover:text-brand-primary transition-colors" @click="$emit('clear')">
      All Subcategories
    </button>
