...
const definitions = [
  ...
  },
  {
    ...
    items: [
      ...
      { term: 'Confidence %', description: 'Products with a fresh usable price on both sides, over the eligible set (the products making up our top 80% of revenue). Used ÷ Eligible — how much of the revenue-weighted range a PI is actually built on. The same figure Executive and Commercial both label Confidence %; it was called Coverage %, then Util %, before the three views were reconciled.', icon: Target },
